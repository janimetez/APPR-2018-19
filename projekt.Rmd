...
Tabela 1 (promet: Število potnikov v posameznei vrsti prevoza):
...
družbene razmere, saj so si ljudje lahko privoščili lasten avtomobil, kar je povzročilo prej omenjen upad.
...
kateri so v Sloveniji vse bolj popularni, predvsem v mestnih okrožjih. Njihovo število strmo narašča in lahko pričakujemo,
...
```{r zemljevid_cluster_place, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Zemljevid 4', warning=FALSE} 
zemljevid_cluster_place 
